...
testthat::test_that("DSL02 is produced correctly", {
  ...
  expected_table <- structure(
    c(
      ...
      "ARM A", "", "", "Date of First", "Study Drug", "Administration", "2020-10-12", "2020-05-12", "2021-01-24",
      "2020-10-14", "2021-08-28", "2019-12-27", "2020-02-01", "2021-04-12", "2020-12-31", "2020-08-14", "", "",
