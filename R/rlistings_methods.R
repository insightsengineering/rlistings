...
print.listing_df <- function(x, widths = NULL, tf_wrap = FALSE, max_width = NULL, fontspec = NULL, col_gap = 3L,  ...) {
  cat(toString(matrix_form(x, fontspec = fontspec, col_gap = col_gap), widths = widths, tf_wrap = tf_wrap, max_width = max_width, fontspec = fontspec, col_gap = col_gap,  ...))
  invisible(x)
}
...
setMethod("toString", "listing_df", function(x, widths = NULL, fontspec = NULL, col_gap = 3L,  ...) {
  toString(matrix_form(x, fontspec = fontspec, col_gap = col_gap), fontspec = fontspec, col_gap = col_gap, widths = widths,  ...)
})
